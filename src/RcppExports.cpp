...
RcppExport SEXP _generalExceedance_compute_prob(SEXP mSEXP, SEXP R_g_valueSEXP, SEXP R_h_valueSEXP, SEXP n_tSEXP, SEXP R_diff_tSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _generalExceedance_compute_prob_fft(SEXP mSEXP, SEXP R_g_valueSEXP, SEXP R_h_valueSEXP, SEXP n_tSEXP, SEXP R_diff_tSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< R_xlen_t >::type m(mSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_generalExceedance_compute_prob", (DL_FUNC) &_generalExceedance_compute_prob, 5},
    {"_generalExceedance_compute_prob_fft", (DL_FUNC) &_generalExceedance_compute_prob_fft, 5},
    {NULL, NULL, 0}
};

RcppExport void R_init_generalExceedance(DllInfo *dll) {
